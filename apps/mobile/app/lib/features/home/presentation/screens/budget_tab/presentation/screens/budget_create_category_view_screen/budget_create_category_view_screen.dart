...
import '../budget_name_category_view_screen/budget_name_category_view_screen.dart';

class BudgetChooseCategoriesForViewScreen extends HookWidget {
  const BudgetChooseCategoriesForViewScreen({super.key});

  static String route = '/budget/settings/create_category_view';
  ...
  Widget build(BuildContext context) {
    return ChooseCategoriesForViewScreen(
      onComplete: (payload) {
        ...
        GoRouter.of(context).go(BudgetNameCategoryViewScreen.route);
      },
    );
  }
}
