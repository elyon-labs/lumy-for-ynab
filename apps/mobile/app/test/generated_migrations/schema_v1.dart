...
class DbSpendTrackers extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  DbSpendTrackers(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
    aliasedName,
    false,
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'db_spend_trackers';
  @override
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  Never map(Map<String, dynamic> data, {String? tablePrefix}) {
  ...
  @override
  DbSpendTrackers createAlias(String alias) {
    return DbSpendTrackers(attachedDatabase, alias);
  }
}
...
class DatabaseAtV1 extends GeneratedDatabase {
  ...
  late final DbSpendTrackers dbSpendTrackers = DbSpendTrackers(this);
